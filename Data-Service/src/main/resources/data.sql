...
INSERT INTO FUNCTIONAL_DEVICE (id, type, name, manufacturer, serial_number, consumed_electricity, created_at, home_id, power_level) VALUES (1, 'AIR_FILTER', 'Dual Scan AC3858/51', 'PHILIPS', 'HIBWCDUIYHWASDAD', '60', '2022-11-01', 1, 3);
...
INSERT INTO FUNCTIONAL_DEVICE (id, type, name, manufacturer, serial_number, consumed_electricity, created_at, home_id, power_level) VALUES (2, 'AIR_CONDITIONER', 'Klimatyzator ścienny ECO KEX', 'PHILIPS', 'HIBWCDUIYHWASDAE', '3500', '2022-11-05', 1, 3);
...
INSERT INTO FUNCTIONAL_DEVICE (id, type, name, manufacturer, serial_number, consumed_electricity, created_at, home_id, power_level) VALUES (3, 'AIR_HUMIDIFIER', 'Nawilżacz powietrza HU4801/01', 'PHILIPS', 'HIBWCDUIYHWASDAF', '20', '2022-11-05', 1, 3);