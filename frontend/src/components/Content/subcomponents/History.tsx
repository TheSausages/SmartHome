...
export default function History(props: HistoryProps) {
    ...
    // div is added, because selenium has problems with svg elements (generated by LineChart)
    <div id="chart">
                ...
                <h3>{deviceNameMapper(activeDevice)}</h3>
                    <form method="get" onSubmit={handleOnSubmit}>
                        <Stack direction="row" sx={{width: '70%', marginLeft: '20%', marginRight: '10%'}}>
                                ...
                                <Input id="date-start" type="date" value={startDate} onChange={handleOnStartDateChange} />
                                <p style={{marginLeft: '20px', marginRight: '20px'}}>Do:</p>
                                <Input id="date-end" type="date" value={endDate} onChange={handleOnEndDateChange} />
                                <Button id="history-get-button" sx={{minWidth: '100px', marginLeft: '20px', height:'20px', marginTop:'20px', backgroundColor: 'rgba(76, 175, 80, 0.7)'}} variant="contained" type="submit">Wyświetl</Button>
                        </Stack>
                    </form>
                <br/>
                <br/>
